...
* {ServerlessLogicProductName} workflows deployed using the `dev` or `preview` profiles are now automatically configured to generate monitoring metrics for Prometheus.
